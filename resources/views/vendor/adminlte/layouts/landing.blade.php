    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>Laravel Contacts</b></a>
            </div>
        ...
        <div id="headerwrap">
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        <h1>Laravel <b><a href="https://github.com/acacha/adminlte-laravel">Contacts</a></b></h1>
                    ...
                    <div class="col-lg-8">
                        <img class="img-responsive" src="{{ asset('/img/Contacts.png') }}" alt="">
                    </div>
                    <div class="col-lg-2">
                        <br>
